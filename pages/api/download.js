...
const MAC_URL = 'https://github.com/qrexact-droid/mediagoai/releases/download/v1.0.0/AIGO_Media_Setup_Mac_v1.1.5.zip'
const WIN_URL = 'https://github.com/qrexact-droid/mediagoai/releases/download/v1.0.0/AIGO_Media_Setup_Win_v1.1.5.zip'
